  ...
  const testimonials = [
    {
      id: 1,
      name: 'Parthipan NB',
      quote: 'Vplat totally changed my life.Now i make 1000$ weekly.Am so happy',
    },
    {
      id: 2,
      name: 'Aswin SV',
      quote: 'Vplat helped me to improve all of my skills.It helped in improving my overall skills etc.',
    },
    {
      id: 3,
      name: 'David Johnson',
      quote: 'I love this platform,helped me from going broke to a G',
    },
  ];
