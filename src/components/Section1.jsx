        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="text-gray-300 text-center">
             A private discord server to clear all doubts and host meeting with mentor.
            </p>
          </motion.div>
          <motion.div
            className="flex flex-col items-center"
          ...
          >
            ...
            <p className="text-gray-300 text-center">
              A 24x7 available mentor to guide you through your journey.
            </p>
          </motion.div>
          <motion.div
            className="flex flex-col items-center"
          ...
          >
            ...
            <p className="text-gray-300 text-center">
              A offline meeting with Mentor and Team once in 6 months.
            </p>
          </motion.div>
