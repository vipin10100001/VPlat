        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">
              Address: 1234 Main Street, Electronic City,Banglore,India
            </p>
            <p className="text-gray-400 mb-2">Email: memebers@vplat.com</p>
            <p className="text-gray-400">Phone: +918547858740</p>
          </div>
        </div>
        <hr className="my-8 border-gray-800" />
        <p className="text-center text-gray-400">
          &copy; {new Date().getFullYear()} Vplat App. All rights reserved.
        </p>
      </div>
    </footer>
  );
